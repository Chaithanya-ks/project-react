...
const Testimonials = () => {
  return (
    <div className='pb-14 px-8 md:px-0'>
        ...
        <p className='md:text-base text-gray-500 mt-3'>Hear from our learners as they share their journey of transformation, success, and how our<br/>
        platform has made a difference in their lives.</p>

        <div className=' grid-auto-fit  gap-8 mt-14'>
          {dummyTestimonial.map((testimonials, index)=>(
            <div key={index} className='text-sm text-left border border-gray-500/30 pb-6 rouded-lg
