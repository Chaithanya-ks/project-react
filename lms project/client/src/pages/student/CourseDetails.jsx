  ...
  return courseData ? (
    <>
      <div
        ...
        md:px-36 px-8 md:pt-30 pt-20 text-left bg-gradient-to-b from-cyan-100/70 min-h-screen"
      >
        ...
        <div className="max-w-xl z-10 text-gray-500">
          ...
          <p className="text-sm ">Course by <span className="text-blue-600 underline">CKS</span></p>
